# Anjali Mangla
# 9/24/2018
# I decided to make a project about someone saving the prince for once, since we often see the worn-out damsel-in-distress trope in the media and especially video games. I wanted to make a game that was out-of-the-box and represented feminism, something I care about, and the prince being saved for once. I believe that switching roles once in a while is helpful! This adventure game has a 5 minute timer and it penalizes the user for not remembering a riddle or not thinking about saving the prince and wasting time. I hope whoever plays this game has fun!
# Sources: only class
